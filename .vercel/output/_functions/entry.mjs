...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_bCBBIgHL.mjs';
import { manifest } from './manifest_BcCEGMFk.mjs';
...
const _args = {
    "middlewareSecret": "5d9cdebf-87d9-4132-a7d9-ca1c31624b6c",
