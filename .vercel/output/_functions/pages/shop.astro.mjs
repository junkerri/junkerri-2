import { e as createAstro, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as renderScript, d as addAttribute } from '../chunks/astro/server_C7Z8jh5L.mjs';
import 'kleur/colors';
...
8 x 10
</button> </div> </div>`} ${product.inStock ? renderTemplate`<div data-astro-cid-5w43p2qc> <button class="btn btn-primary btn-md w-full"${addAttribute(product.id, "data-product-id")}${addAttribute(product.stripePriceId, "data-price-id")} data-astro-cid-5w43p2qc>
Add to Cart
<svg class="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-5w43p2qc> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" data-astro-cid-5w43p2qc></path> </svg> </button> </div>` : renderTemplate`<button class="btn btn-outline btn-md w-full cursor-not-allowed" disabled data-astro-cid-5w43p2qc>
Out of Stock
